...
public class UpdateStudentDialog extends JDialog {
	 ...
	 * @param stuTableName 
	 */
	public UpdateStudentDialog(String stuTableName,String values) {
...
//		setBounds(100, 100, 772, 700);
		...
		labIdCard.setBounds(51, 362, 64, 22);
		...
		labNotPassReason.setBounds(39, 547, 98, 15);
		contentPanel.add(labNotPassReason);
		
		JTextArea textNotPassReason = new JTextArea();
		textNotPassReason.setEditable(false);
		textNotPassReason.setBounds(148, 545, 536, 78);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						updateBean.setEmail(textEmail.getText());
						updateBean.setContactway(textContactWay.getText());
						updateBean.setAddress(textAddress.getText());
						updateBean.setEnglish(textEnglish.getText());
						updateBean.setIdcard(textIdCard.getText());
						updateBean.setRewardpunishment(textAreaRewardorPunishment.getText());
						updateBean.setSid(values);
						
						int num=sAction.UpdateStudent(updateBean,SelectStudent.studentTableName);
